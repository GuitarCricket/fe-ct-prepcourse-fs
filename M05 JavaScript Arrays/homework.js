...
function todosIguales(array) {
   ...
   // Tu código:
   var comparo = array.every(elementos =>{
      return elementos === array[0];
   });
   return comparo;
}
...
function mayorACien(array) {
   ...
   var corchete = [];
   for (var i = 0 ; i < array.length ; i++){
     if(typeof array[i] === 'number'&& array[i] >= 0 && array[i] <= 200 && array[i] > 100){
        corchete.push(array[i]);
     }
   }
   return corchete;
}
